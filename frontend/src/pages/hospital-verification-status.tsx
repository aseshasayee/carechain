...
export default function HospitalVerificationStatus() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(90deg, #e0f7fa, #caf0f8)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#fff', borderRadius: 20, boxShadow: '0 4px 24px #bde0fe', padding: 40, minWidth: 400, maxWidth: 500, marginTop: 60 }}>
        <h2 style={{ fontSize: 28, fontWeight: 700, color: '#0077b6', marginBottom: 24 }}>Hospital Verification Status</h2>
        {loading ? (
          ...
          <>
            ...
            <div style={{ marginTop: 24 }}>
              <Link href="/hospital-profile" style={{ color: '#0077b6', fontWeight: 600, textDecoration: 'underline' }}>Go to Hospital Profile</Link>
            </div>
          </>
        ) : null}
      </div>
